...
// Throw an exception if we can't read the jar
fs.accessSync(PLANTUML_JAR, fs.constants.R_OK);
...
// Throw an exception if we can't read the jar
fs.accessSync(PLANTUML_NAIL_JAR, fs.constants.R_OK);
