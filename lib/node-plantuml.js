...
function arrangeArguments (input, options, callback, javaCfg) {
...
module.exports.generate = function (input, options, callback, javaCfg) {
  var args = arrangeArguments(input, options, callback, javaCfg)
  input = args.input
  options = args.options
  callback = args.callback
  javaCfg = args.javaCfg

  var o = joinOptions([PIPE], options)
  var child = plantumlExecutor.exec(o, options.include, callback, javaCfg)
